...
Uma dica para saber se estes perfis ICC são potencialmente úteis pra você, é verificar se a cor verde (#00FF00) parece um verde-limão. Se o seu verde não for parecido com verde-limão, este repositório deve ser desconsiderado e estes perfis não serão úteis pra você.
